-- =====================================================
-- MOROCCO TOURISM FORM - CLEAN SLATE SCHEMA
-- =====================================================
-- This will DROP existing tables and create the proper schema

-- Drop existing tables if they exist (clean slate)
DROP TABLE IF EXISTS modification_log CASCADE;
DROP TABLE IF EXISTS client_notes CASCADE;
DROP TABLE IF EXISTS additional_travelers CASCADE;
...
('admin', 'admin@experiencemorocco.com', 'System Administrator', '$2b$10$Cz4rPJZfKXvgglEQYUkGceB2Mku/X6XvDK1EbWie7mIkWiCOJwXNa', 'Admin', true, true);
